...
class DirectV2CardServiceImpl : CommonDirectV2ServiceImpl(), DirectV2PayMethodService<DirectV2Card> {

    override fun registration(data: DirectV2Card, config: NICEPay?): NICEPayResponseV2? {
        var nicePayResponse: NICEPayResponseV2? = null
        val directV2Service : DirectV2Service<DirectV2Card, RegistrationDirectV2Api> = DirectV2ServiceImpl()
        try {
